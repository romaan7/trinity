...
#
# This script identifies the type of hashes in file and adds them to new file based on type.
# Hash identification is based on length and the identifier specifed, a better method needs to be implemented.
